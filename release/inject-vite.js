...
let H, W, q;
const $ = new Promise(t => H = t), w = new Promise(t => W = t), k = new Promise(t => q = t), h = (t, r) => {
...
document.onreadystatechange = function () {
    document.readyState === "complete" && (h("#player.ytd-watch-flexy", H), h("ytd-watch-flexy", W), h("ytd-app", q))
};
var P = function (t, r) {
...
var _ = function () {
    ...
    return t.prototype.unsubscribe = function () {
        ...
        if (!this.closed) {
            ...
            if (I) {
                this._finalizers = null;
                try {
                    for (var p = O(I), f = p.next(); !f.done; f = p.next()) {
                        var Z = f.value;
                        try {
                            U(Z)
                        } catch (a) {
                            i = i ?? [],
                            a instanceof E ? i = b(b([], v(i)), v(a.errors)) : i.push(a)
                        }
                    }
                } catch (a) {
                    n = {
    ...
    t.prototype._removeParent = function (r) {
        var e = this._parentage;
        e === r ? this._parentage = null : Array.isArray(e) && T(e, r)
    },
    t.prototype.remove = function (r) {
        var e = this._finalizers;
        e && T(e, r),
        r instanceof t && r._removeParent(this)
    },
    t.EMPTY = function () {
        var r = new t;
        return r.closed = !0,
...
(), K = _.EMPTY;
function V(t) {
    return t instanceof _ || t && "closed" in t && l(t.remove) && l(t.add) && l(t.unsubscribe)
}
function U(t) {
    l(t) ? t() : t.unsubscribe()
}
var G = {
    ...
    setTimeout: function (t, r) {
        for (var e = [], n = 2; n < arguments.length; n++)
            e[n - 2] = arguments[n];
        var o = C.delegate;
        return o != null && o.setTimeout ? o.setTimeout.apply(o, b([t, r], v(e))) : setTimeout.apply(void 0, b([t, r], v(e)))
    },
...
var J = function (t) {
    ...
    function r(e) {
        ...
        e ? (n.destination = e, V(e) && e.add(n)) : n.destination = ne,
        n
    }
...
(), j = function (t) {
    ...
    function r(e, n, o) {
        ...
        if (l(e) || !e)
            ...
            var u;
            i && G.useDeprecatedNextContext ? (u = Object.create(e), u.unsubscribe = function () {
                return i.unsubscribe()
            }, s = {
                    next: e.next && x(e.next, u),
                    error: e.error && x(e.error, u),
                    complete: e.complete && x(e.complete, u)
                }) : s = e
        }
        return i.destination = new te(s),
        i
    }
    return r
}
...
function D(t) {
    var r;
    return (r = t ?? G.Promise) !== null && r !== void 0 ? r : Promise
}
function ue(t) {
    return t && l(t.next) && l(t.error) && l(t.complete)
}
function ce(t) {
    return t && t instanceof J || ue(t) && V(t)
}
var ae = B(function (t) {
    return function () {
        t(this),
    ...
    r.prototype._innerSubscribe = function (e) {
        ...
        s = o.isStopped,
        u = o.observers;
        return i || s ? K : (this.currentObservers = null, u.push(e), new _(function () {
...
ve();
function le() {
    window.addEventListener("extension-enabled", function (r) {
        A.next(r.detail),
        Y()
    });
    const t = new CustomEvent("inject-ready");
    window.dispatchEvent(t),
    window.addEventListener("schedule-player-size-update", Y)
}
async function Y() {
    (await w).schedulePlayerSizeUpdate_()
}
function fe() {
    A.subscribe({
        next: t => {
            console.log("extensionEnabledSubject", t),
            t ? de() : he()
        }
    })
}
async function pe() {
    const t = await w;
    X = t.calculateCurrentPlayerSize_,
    m = t.isTwoColumns_
}
async function de() {
    const t = await w,
    ...
    m = t.isTwoColumns_,
    t.isTwoColumns_ = !1,
    Object.defineProperty(t, "isTwoColumns_", {
        get: function () {
            return !1
        },
        set: function (e) {
    ...
    t.calculateCurrentPlayerSize_ = function () {
        let e = r.clientWidth,
        n = document.documentElement.clientHeight - 104;
        return {
            width: e,
            height: n
        }
...
async function he() {
    const t = await w;
    delete t.isTwoColumns_,
    t.isTwoColumns_ = m,
    t.calculateCurrentPlayerSize_ = X
}
async function ye() {
    const t = await k;
    window.addEventListener("fullscreenchange", function (r) {
        const e = new CustomEvent("fullscreen", {
            detail: t.fullscreen
        });
...
function ve() {
    A.subscribe({
        next: t => {
            t ? document.body.addEventListener("yt-page-data-updated", R) : document.body.removeEventListener("yt-page-data-updated", R)
        }
    })
}
